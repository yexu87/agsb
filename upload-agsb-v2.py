...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "rregregg"         # 用户名
UUID = "16fea94d-fa7e-46d1-acc9-9996a7eafe77"                     # UUID，留空则自动生成
PORT = 59999                   # Vmess端口，留空或0则自动生成
DOMAIN = "suidao.xddx.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiOGU5OTllYmUxNzQ4ZTRjYjA4ZGVjYTcyNDc5NjdmYWMiLCJ0IjoiOWE1Njg4ZWQtOTUxYy00ZDAxLWIwOTYtMzIxMWNmZmJkZmUxIiwicyI6Ik1qRmhOV015WkRJdE0yUTFOaTAwTVRZNUxXSm1OR0V0T1RVelptUXdNMlU0WWpFMSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
